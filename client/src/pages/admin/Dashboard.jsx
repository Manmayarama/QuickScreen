...
import { ChartLineIcon, StarIcon, PlayCircleIcon, UsersIcon, BadgeIndianRupee } from 'lucide-react';
...
const Dashboard = () => {
  ...
  const dashboardCards = [
    ...
    { title: "Total Revenue", value: currency + dashboardData.totalRevenue || "0", icon: BadgeIndianRupee },
